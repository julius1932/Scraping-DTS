...
var START_URL = 'https://www.croma.com/phones/mobile-phones/c/10';

var pagesVisited = {};
var numPagesVisited = 0;
var pagesToVisit = [START_URL];
for (var i = 1; i < 14; i++) {
    pagesToVisit.push("https://www.croma.com/phones/mobile-phones/c/10?q=%3Arelevance%3AskuStockFlag%3Atrue&page=" + i);
}
var pagesUrls = [];
var numItems = 0;
var  allLinks=[];
