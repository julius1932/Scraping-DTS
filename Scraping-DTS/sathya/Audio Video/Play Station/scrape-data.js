...
var START_URL = 'https://www.sathya.in/play-station';

var pagesVisited = {};
var numPagesVisited = 0;
var pagesToVisit = jsonfile.readFileSync('p-s-links.json');
var pagesUrls = [];
var numItems = 0;
var allData = [];
...
function scrapeItem($, url) {
    ...
    item.description = $("div.more-block  p").text();
    ...
    numItems++;
    console.log(item);
    saveJson('p-s-data.json', allData);
}
